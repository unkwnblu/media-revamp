      ...
      <div ref={ref} className="max-w-[1400px] mx-auto relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <Link
            ...
            className={`group relative aspect-[3/4] lg:aspect-auto overflow-hidden rounded-xl transition-all duration-700 delay-200 ${
              inView
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-10">
              <span className="text-[10px] tracking-widest opacity-60 block mb-3 text-purple-200">
                {featured[0].category}
              </span>
              ...
              <span className="block mt-3 text-[10px] tracking-widest opacity-40">
                {featured[0].year}
              </span>
            </div>
          </Link>
          ...
          <div className="grid grid-rows-2 gap-4">
            {featured.slice(1, 3).map((project, i) => (
              <Link
                ...
                className={`group relative aspect-[16/9] overflow-hidden rounded-xl transition-all duration-700 ${
                  inView
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-12"
                }`}
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                  ...
                  <h3 className="font-heading font-black text-xl md:text-2xl group-hover:translate-x-2 transition-transform duration-500">
                    {project.title}
                  </h3>
                </div>
              </Link>
