        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <span className="text-xs tracking-widest text-purple-300/80">
          ...
          <div
            className={`lg:col-span-3 lg:col-start-10 flex lg:flex-col justify-start gap-6 transition-all duration-700 delay-400 ${
              inView
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
          >
            {testimonials.map((t, i) => (
              ...
              >
                ...
                />
                <span className="text-[10px] tracking-widest hidden lg:block">
                  {t.author}
                </span>
              </button>
            ))}
